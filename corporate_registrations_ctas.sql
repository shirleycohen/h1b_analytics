...
from sec_of_state.Corporate_Registrations_MN_1 mn1 join sec_of_state.Corporate_Registrations_MN_2 mn2 on mn1.master_id = mn2.master_id
where mn1.minnesota_business_name is not null and mn2.city_name is not null and mn2.region_code = 'MN' and mn1.filing_date is not null
...
from sec_of_state.Corporate_Registrations_MO_1 mo1 join sec_of_state.Corporate_Registrations_MO_2 mo2 on mo1.corporation_id = mo2.corporation_id
where mo2.state = 'MO'
order by mo1.name;
