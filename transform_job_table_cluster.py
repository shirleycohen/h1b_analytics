  ...
  def process(self, element):
    ...
    if number_records == 2:
        ...
        for job_record in job_matches:
            ...
            if non_empty_worksite == 1 and worksite_postal_code != None:
            ...
            if 'pw_unit_of_pay' in job_record:
                ...
                if pw_unit_of_pay == None:
                    job_record.pop('pw_unit_of_pay')
                elif pw_unit_of_pay[0].isdigit():
            ...
            if 'wage_rate_of_pay_to' in job_record:
                ...
                if wage_rate_of_pay_to == None or wage_rate_of_pay_to == 0.0:
...
with beam.Pipeline('DataflowRunner', options=opts) as p:
    ...
    job_query_str = 'SELECT *, EXTRACT(YEAR FROM employment_start_date) AS employment_start_year ' \
                    'FROM `h1b_split.Job_Temp` ORDER BY employer_name'
